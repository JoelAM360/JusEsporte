...
import { CardElement } from "../../shared/components";
import { LayoutDashboard } from "./Layout.Dashboard";

// Admin components
const Overview = () => (
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <CardElement estatisca="52% dos advogados são jogadores" quantidade="123" title="Advogados" />
    <CardElement estatisca="12% de times" quantidade="123" title="Times" />
    <CardElement estatisca="12% de times" quantidade="123" title="Tonreios" />
  </div>
);
